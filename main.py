...
class AdbControllerApp(ctk.CTk):
    ...
    def update_app(self):
        ...
        def _update_in_thread():
            ...
            try:
                ...
                messagebox.showinfo("Update Success", "The application has been successfully updated. Please close and reopen the software to use the new version.")
                
                self.status_label.configure(text=f"✅ Update successful! Please restart the application.", text_color="#28a745")
                self.destroy()
    ...
    def detect_devices(self):
        ...
        for widget in self.device_view_panel.winfo_children():
            # Check if the widget is not the stop_all_button
