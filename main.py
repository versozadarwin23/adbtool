...
class AdbControllerApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        # Update button at the bottom of the control panel

        self.update_button = ctk.CTkButton(self.control_panel, text="Update", command=self.update_app,

                                           fg_color="#007bff", hover_color="#0056b3", corner_radius=8)

        self.update_button.grid(row=6, column=0, sticky='ew', padx=25, pady=(10, 20))
    ...
    def update_app(self):
        ...
        Downloads the latest version of the app from a GitHub URL and saves it to the Desktop.
        ...
        def _update_in_thread():
            ...
            try:
                ...
                response.raise_for_status()  # It raises an exception for bad status codes
                ...
                save_path = desktop_path / "main.py"
                ...
                self.status_label.configure(text=f"✅ Update successful! New file saved to: {save_path}", text_color="#28a745")

                messagebox.showinfo("Update", f"Update successful! Please restart the application to use the new version.")
